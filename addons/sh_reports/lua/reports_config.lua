...
SH_REPORTS.Usergroups = {
	...
	["SuperAdmin VIP"] = true,
	["Administrateur"] = true,
	["Administrateur VIP"] = true,
	["Administrateur Test"] = true,
	["Administrateur Test VIP"] = true,
	["Responsable Administrateur"] = true,
	["Responsable Administrateur VIP"] = true,
	["SuperModerateur"] = true,
	["SuperModerateur VIP"] = true,
	["Moderateur"] = true,
	["Moderateur VIP"] = true,
	...
	["Helper Test"] = true,
	["Helper"] = true,
	["Helper Test VIP"] = true,
	["Responsable Moderateur"] = true,
	["Responsable Moderateur VIP"] = true,
	["Reponsable Helper"] = true,
	["Responsable Helper VIP"] = true,
	["Responsable Staff"] = true,
	["Responsable Staff VIP"] = true,
	["Developpeur"] = true,
}
...
SH_REPORTS.MaxReportsPerPlayer = 5
...
SH_REPORTS.PendingReportsDispNumber = 10
...
SH_REPORTS.AdminReportsCount = true
...
SH_REPORTS.DateFormat = "%d/%m/%Y"

SH_REPORTS.TimeFormat = "%d/%m/%Y %H:%M:%S"
