...
LOUNGE_CHAT.Style = {
	...
	bg = Color(000, 000, 000, 200),
	inbg = Color(000, 000, 000, 200),
...
LOUNGE_CHAT.Language = {
	...
	server_uptime = "Durée de vie du serveur",
	click_to_load_image = "Cliquer pour charger l'image",
	failed_to_load_image = "Échec du chargement de l'image",
	click_here_to_view_x_profile = "Cliquer ici pour voir le profil de %s",
 
	chat_options = "Options du  tchat",
	clear_chat = "Vider le tchat",
	reset_position = "Remettre à zéro la position",
	reset_size = "Remettre à zéro la taille",
 
	chat_parsers = "Modifieurs du  tchat",
	usage = "Usage",
	example = "Exemple",
	...
	chat_x = "Position X",
	chat_y = "Position Y",
	chat_width = "Largeur du tchat",
	chat_height = "Hauteur du tchat",
	time_before_messages_hide = "Temps avant la disparition des messages",
	show_timestamps = "Afficher l'heure des messages",
	clear_downloaded_images = "Vider le dossier des images téléchargées (%s)",
	dont_scroll_chat_while_open = "Ne pas faire descendre le tchat automatiquement quand ouvert",
 
	display = "Afficher",
	hide_images = "Cacher les images",
	hide_avatars = "Cacher les avatars",
	use_rounded_avatars = "Utiliser les avatars circulaires (désactiver si l'IPS est bas)",
	disable_flashes = "Désactiver les couleurs animées",
	no_url_parsing = "Ne pas transformer les liens",
	autoload_external_images = "Charger les images externes automatiquement",
	hide_options_button = "Cacher le bouton des options",
}